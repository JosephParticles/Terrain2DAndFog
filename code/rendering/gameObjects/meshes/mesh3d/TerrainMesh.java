...
public class TerrainMesh extends Mesh3D{
	
	private int colourVboId;

	public TerrainMesh(float[] vertices,int[] indices,float[] colours) {
	    super(indices);
	...
	public void render(Program program, Camera camera, float currentTime){
        ...
        program.setUniform("maxDistance",camera.getMaxViewDistance());
